...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ((!empty($quantidade_cubo) || !empty($quantidade_barra)) && 
        ...
        header("Location: pedidoEntrega.php?success=Pedido adicionado com sucesso!");
        exit;
    } else {
...
<body>
    ...
    <div class="main-container">
        <h1>Adicionar Pedido - Entregador</h1>
        ...
        <div class="form-container">
            <form action="" method="POST">
                ...
                <label for="quantidade_cubo">Quantidade de Gelo em Cubo (Unidades):</label>
                <input type="number" id="quantidade_cubo" name="quantidade_cubo">

                <label for="quantidade_barra">Quantidade de Gelo em Barra (Unidades):</label>
                ...
                <a href="pedidoEntrega.php" class="btn cancel-btn">Cancelar</a>
            </form>
        </div>
    </div>
    <script>
