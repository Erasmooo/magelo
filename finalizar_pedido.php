...
$sql_estoque = "SELECT quantidade_total FROM stock WHERE tipo_produto = :tipo_produto";
...
if ($estoque && $estoque['quantidade_total'] >= $quantidade_pedido) {
    ...
    $sql_update_estoque = "UPDATE stock SET quantidade_total = :nova_quantidade WHERE tipo_produto = :tipo_produto";
